...
static void get_value_test(void) {
	...
	char * paramString = "";
	BC_ASSERT_FALSE(param_string_get_value(paramString, "param", result, result_len));
	
	paramString = "param=true";
	BC_ASSERT_TRUE(param_string_get_value(paramString, "param", result, result_len));
	BC_ASSERT_TRUE(strcmp(result, "true") == 0);
	BC_ASSERT_FALSE(param_string_get_value(paramString, "notparam", result, result_len));
