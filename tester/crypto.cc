...
static void PBKDF2_HMAC_SHA_256_test(void) {
    ...
    std::vector<uint8_t> res = PBKDF2_HMAC_SHA_256(p, s, c, dkLen);
    std::vector<uint8_t> excp {0x55, 0xac, 0x04, 0x6e, 0x56, 0xe3, 0x08, 0x9f, 0xec, 0x16, 0x91, 0xc2, 0x25, 0x44, 0xb6, 0x05,
...
static void PBKDF2_HMAC_SHA_256_2_test(void) {
    std::string p = "Password";
    std::string s = "NaCl";
    int c = 80000;
    size_t dkLen = 64;
    ...
    std::vector<uint8_t> res = PBKDF2_HMAC_SHA_256(p, s, c, dkLen);
    std::vector<uint8_t> excp {0x4d, 0xdc, 0xd8, 0xf6, 0x0b, 0x98, 0xbe, 0x21, 0x83, 0x0c, 0xee, 0x5e, 0xf2, 0x27, 0x01, 0xf9,
