...
static EncryptedVfsOpenCb
    set_dummy_encryption_info([](VfsEncryption &settings) {
...
static EncryptedVfsOpenCb
    set_plain_encryption_info([](VfsEncryption &settings) {
      settings.encryptionSuiteSet(EncryptionSuite::plain);
    });

static EncryptedVfsOpenCb
    set_aes256_encryption_info([](VfsEncryption &settings) {
